      ...
      <div className="bg-white rounded-3xl shadow-sm border border-stone-100 overflow-hidden">
        <div className="p-8 border-b border-stone-100 bg-stone-50/50 flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-stone-500 mt-1">Update your product details and inventory.</p>
          </div>
          <div className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-lg border border-stone-200">
            ...
            <button 
              ...
              className={`w-11 h-6 rounded-full relative transition-colors ${isActive ? 'bg-stone-900' : 'bg-stone-300'}`}
            >
              <div className={`w-4 h-4 bg-white rounded-full absolute top-1 transition-transform ${isActive ? 'translate-x-6' : 'translate-x-1'}`} />
            </button>
          </div>
        </div>
