      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-stone-100/70 via-stone-50 to-white pt-10 pb-16 px-4 sm:px-6 rounded-2xl border border-stone-200/80 shadow-sm mt-4">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-base sm:text-lg text-stone-600 max-w-2xl mx-auto leading-relaxed">
            ...
            <span className="font-semibold text-emerald-700">25% commission</span> with 30-day cookie attribution.
          </p>
        ...
        <section className="px-4 sm:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {campaigns.slice(0, 2).map((camp) => (
              <div
                key={camp._id}
                className="bg-white rounded-xl border border-stone-200 shadow-md hover:shadow-lg transition-shadow overflow-hidden flex flex-col justify-between"
              >
                {camp.bannerImage && (
                  <div className="h-44 w-full relative overflow-hidden bg-stone-100">
                    ...
                    />
                    <div className="absolute top-3 right-3 bg-amber-500 text-white font-extrabold text-xs px-3 py-1.5 rounded-full shadow-md flex items-center gap-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {shops.map((shop) => (
              <Link
                ...
                className="group bg-white rounded-xl border border-stone-200 p-5 shadow-sm hover:shadow-md transition-all flex flex-col justify-between"
              >
                <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredProducts.map((prod) => {
              ...
              return (
                <div
                  key={prod._id}
                  className="group bg-white rounded-xl border border-stone-200 shadow-sm hover:shadow-md transition-all overflow-hidden flex flex-col justify-between"
                >
                  <Link to={`/product/${prod._id}`} className="block">
                    ...
                    <div className="relative w-full h-56 bg-stone-100 overflow-hidden">
                      ...
                      {activeCamp && (
                        <div className="absolute top-2.5 left-2.5 bg-amber-500 text-white font-extrabold text-[11px] px-2.5 py-1 rounded-full shadow flex items-center gap-1">
                      ...
                      <div className="absolute bottom-2.5 right-2.5">
                        {prod.stock > 5 ? (
                          <span className="bg-white/90 backdrop-blur-sm text-stone-700 text-[10px] font-semibold px-2 py-0.5 rounded-full shadow-sm">
                            In Stock
                          </span>
                        ) : prod.stock > 0 ? (
                  ...
                  <div className="p-4 pt-0 border-t border-stone-100 mt-2 flex items-center gap-2">
                    <button
                      ...
                      className="flex-1 bg-[#2E7D32] hover:bg-green-800 disabled:bg-stone-200 disabled:text-stone-400 text-white font-semibold text-xs py-2 px-3 rounded-lg transition-colors flex items-center justify-center gap-1.5"
                    >
